...
/***/ (function(module, exports) {
	...
	var packages = [xsmallPackage, smallPackage, mediumPackage, largePackage, xlargePackage];
	...
	var Slider = function Slider(_ref) {
	  var value = _ref.value,
	    ...
	    return console.log(e);
	      ...
	      _ref$stringifyValue = _ref.stringifyValue,
	      stringifyValue = _ref$stringifyValue === undefined ? function (val) {
	    return val;
	  } : _ref$stringifyValue;
	  ...
	  return React.createElement(
	    ...
	    React.createElement('input', _extends({ className: 'slider', type: 'range' }, { min: min, max: max, value: value, onChange: onChange, step: step })),
	    React.createElement(
	      'span',
	      { style: { marginLeft: 5 } },
	...
	var SliderContainer = function SliderContainer(_ref2) {
	  var _ref2$title = _ref2.title,
	      title = _ref2$title === undefined ? '' : _ref2$title,
	      sliderProps = _objectWithoutProperties(_ref2, ['title']);
	  ...
	  return React.createElement(
	    ...
	    React.createElement(Slider, sliderProps)
	  );
	};

	var PriceTitle = function PriceTitle(_ref3) {
	...
	var App = function App() {
	  var _React$useState = React.useState(20),
	      ...
	      reservations = _React$useState2[0],
	      setReservations = _React$useState2[1];

	  var reservationSlider = {
	    onChange: function onChange(e) {
	      return setReservations(e.target.value);
	    },
	    value: reservations,
	    min: 10,
	    max: 500,
	  ...
	  var _React$useState3 = React.useState(6),
	      ...
	      shifts = _React$useState4[0],
	      setShifts = _React$useState4[1];

	  var shiftSlider = {
	    onChange: function onChange(e) {
	      return setShifts(e.target.value);
	    },
	    value: shifts,
	    min: 1,
	    max: 7,
	  ...
	  var currentPackage = React.useMemo(function () {
	    var totalReservations = Math.round(reservations * shifts * (52 / 12));

	    var packs = packages.map(function (p) {

	      var extra = (totalReservations * 1.05 - p.includedRes) * p.additionalRes;

	      var price = Math.round(Math.max(0, extra)) + p.price;

	      return { price: price, title: p.title, totalReservations: totalReservations };
	    });
	  ...
	  var _React$useState5 = React.useState(0.1),
	      _React$useState6 = _slicedToArray(_React$useState5, 2),
	      otPercentage = _React$useState6[0],
	      setotPercentage = _React$useState6[1];

	  var _React$useState7 = React.useState(99),
	      _React$useState8 = _slicedToArray(_React$useState7, 2),
	      otPackage = _React$useState8[0],
	      setotPackage = _React$useState8[1];

	  var openTablePrice = React.useMemo(function () {
	    var totalReservations = Math.round(reservations * shifts * (52 / 12));
	  ...
	  var opentableSlider = {
	    onChange: function onChange(e) {
	      return setotPercentage(e.target.value);
	    },
	    value: otPercentage,
	    min: 0.05,
	    max: 1,
	    step: 0.05,
	    stringifyValue: function stringifyValue(val) {
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement('img', { src: '../assets/logo2.gif', alt: 'loading...', width: 'auto', height: '80px' })
	    ),
	    React.createElement(
	      'div',
	      { className: 'main' },
	      React.createElement(
	        'div',
	        { className: 'mainLeft' },
	        React.createElement(SliderContainer, _extends({}, shiftSlider, { title: '\xD6ffnungstage pro Woche' })),
	        React.createElement(SliderContainer, _extends({}, reservationSlider, { title: 'Platzierungen pro Tag' })),
	        React.createElement(
	          'div',
	          null,
	          React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { className: otPackage === 29 ? 'active' : '', onClick: function onClick() {
	                  return setotPackage(29);
	                } },
	              'Basic (29,00 \u20AC)'
	            ),
	            React.createElement(
	              'button',
	              { className: otPackage === 99 ? 'active' : '', onClick: function onClick() {
	                  return setotPackage(99);
	                } },
	              'Core (99,00 \u20AC)'
	            ),
	            React.createElement(
	              'button',
	              { className: otPackage === 199 ? 'active' : '', onClick: function onClick() {
	                  return setotPackage(199);
	                } },
	              'Pro (199,00 \u20AC)'
	            )
	          ),
	          React.createElement(
	            'span',
	            { style: { marginBottom: 10, color: '#d3d3d3' } },
	            'PLUS'
	          ),
	          React.createElement(SliderContainer, _extends({}, opentableSlider, { title: 'Geworbene Kunden in % (1,50 \u20AC / Gast)' })),
	          React.createElement(
	            'div',
	            { className: 'prices' },
	            React.createElement(PriceTitle, { price: openTablePrice, label: 'Open Table' }),
	            React.createElement(
	              'span',
	              null,
	              'vs'
	            ),
	            React.createElement(PriceTitle, { price: currentPackage.price, label: 'Gastronaut' })
	          )
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            ' ',
	            currentPackage.totalReservations
	          ),
	          React.createElement(
	            'p',
	            null,
